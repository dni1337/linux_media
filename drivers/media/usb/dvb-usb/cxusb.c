...
#ifdef MYGICA_T230_SUPPORT
	DVB_USB_DEV(CONEXANT, MYGICA_T230),
	DVB_USB_DEV(CONEXANT, MYGICA_T230C),
	DVB_USB_DEV(CONEXANT, MYGICA_T230C2),
	DVB_USB_DEV(CONEXANT, MYGICA_T230C_LITE),
	DVB_USB_DEV(CONEXANT, MYGICA_T230C2_LITE),
	DVB_USB_DEV(GTEK, MYGICA_X9330_0),
	DVB_USB_DEV(GTEK, MYGICA_X9330_1),
	DVB_USB_DEV(GTEK, MYGICA_X9330_2),
	DVB_USB_DEV(GTEK, MYGICA_X9330_3),
#endif
	{ }
};
...
static struct dvb_usb_device_properties cxusb_mygica_t230c_properties = {
	...
	.devices = {
		...
		},
		{
			"EyeTV T2 lite",
			{ NULL },
			{ &cxusb_table[MYGICA_T230C_LITE], NULL },
		},
		{
			"EyeTV T2 lite 2",
			{ NULL },
			{ &cxusb_table[MYGICA_T230C2_LITE], NULL },
		},
	}
};
